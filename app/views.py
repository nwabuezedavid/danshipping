...
def TruckLoad(request):
    return render(request, 'LTLandTruckLoad.html')
def Requestforquote(request):
    return render(request, 'Requestforquote.html')
def TRACKINGRESULT(request, pk):
    ...
    return render(request, 'TRACKINGRESULT.html',{'item':s})
def SeaFreight(request):
    return render(request, 'SeaFreight.html')
def SeawaveLogistics(request):
    return render(request, 'SeawaveLogistics.html')
def ContactheretoAdministrator(request):
    return render(request, 'ContactheretoAdministrator.html')
def CustomsBrokerage(request):
    return render(request, 'CustomsBrokerage.html')
